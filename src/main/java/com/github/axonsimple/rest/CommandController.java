...
public class CommandController {
    ...
    @PostMapping("/rooms/{roomId}/pending")
    public Future<Void> pendingParticipant(@PathVariable String roomId, @RequestBody @Valid Participant participant) {
        return commandGateway.send(new PendingCommand(roomId, participant.getName()));
    }
