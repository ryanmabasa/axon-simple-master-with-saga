...
public class ChatRoom {
    ...
    @CommandHandler
    public void handle(PendingCommand command) {
        logger.info("[Aggregate][Command] Handle command: {}", command);
        AggregateLifecycle.apply(new PendingEvent(command.getRoomId(), command.getParticipant()));
    }
